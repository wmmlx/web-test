    ...
    .sn-container {
        ...
        .pd-info-center {
            ...
            .y-center {
                ...
                .info-1-0 {
                    background-image: url(../../../assets/dynamic/info-1-0.png);
                ...
                .info-1-1 {
                    background-image: url(../../../assets/dynamic/info-1-1.png);
                    -webkit-animation-duration: 20s;
                    -moz-animation-duration: 20s;
                    -o-animation-duration: 20s;
                    animation-duration: 20s;
                ...
                .info-1-2 {
                    background-image: url(../../../assets/dynamic/info-1-2.png);
                    -webkit-animation-duration: 20s;
                    -moz-animation-duration: 20s;
                    -o-animation-duration: 20s;
                    animation-duration: 20s;
                ...
                .info-1-3 {
                    background-image: url(../../../assets/dynamic/info-1-3.png);
                ...
                .info-1-4 {
                    background-image: url(../../../assets/dynamic/info-1-4.png);
            ...
            .y-number {
                ...
                &.y-number-1 {
                    ...
                    animation-delay: 1s;
                    background: url(../../../assets/dynamic/info-line-01.png) no-repeat 180px center;
                    height: 60px;
                    top: 15px;
                    .y-number-bg {
                        ...
                        animation-delay: 2s;
                        background: url(../../../assets/dynamic/info-bg-01.png) no-repeat 50% 50%;
                    }
                    .y-number-icon {
                        background: url(../../../assets/dynamic/info-icon-1.png) no-repeat 50% 50%;
                    }
                }
                &.y-number-2 {
                    ...
                    background: url(../../../assets/dynamic/info-line-02.png) no-repeat 180px center;
                    height: 60px;
                    top: 70px;
                    padding-left: 350px;
                    .y-number-bg {
                        ...
                        background: url(../../../assets/dynamic/info-bg-02.png) no-repeat 50% 50%;
                    }
                    .y-number-icon {
                        background: url(../../../assets/dynamic/info-icon-2.png) no-repeat 50% 50%;
                    }
                }
                &.y-number-3 {
                    ...
                    .y-number-bg {
                        ...
                        -o-animation-delay: 3s;
                        animation-delay: 3s;
                        background: url(../../../assets/dynamic/info-bg-03.png) no-repeat 50% 50%;
                    }
                    .y-number-icon {
                        background: url(../../../assets/dynamic/info-icon-3.png) no-repeat 50% 50%;
                    }
                }
                &.y-number-4 {
                    ...
                    .y-number-bg {
                        ...
                        background: url(../../../assets/dynamic/info-bg-04.png) no-repeat 50% 50%;
                    }
                    .y-number-icon {
                        background: url(../../../assets/dynamic/info-icon-4.png) no-repeat 50% 50%;
                    }
                }
            }
        }
